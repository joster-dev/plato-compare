...
export const PhaedrusRobin: Turn<PhaedrusCharacter>[] = [
  ...
  },
  {
    character: PhaedrusCharacter.Socrates,
    speech: [
      `Phaedrus, you're making a fool of yourself in say- ing that. You badly misjudge your friend if you think he's as easily frightened as you suggest. But perhaps you think that the man who was laying into him really meant all his rudeness.`,
    ],
  },
  {
    character: PhaedrusCharacter.Phaedrus,
  ...
  },
  {
    character: PhaedrusCharacter.Phaedrus,
    speech: [
      `What a wonderful kind of diversion you're describing, Socrates––that of a person who can amuse him- self with words, as he tells stories about justice and the other things you mentioned––compared with the trivial pastimes of others!`,
    ],
  },
  {
    character: PhaedrusCharacter.Socrates,
