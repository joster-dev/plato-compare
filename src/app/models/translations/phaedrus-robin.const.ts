  ...
  turns: [
    ...
    },
    {
      ...
      speech: [
        ...
        `I imagine that Lysias was entertaining you all with a feast of words.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Phaedrus,
      speech: [
        `Actually, Socrates, you're the perfect person to hear about it,`,
        `because you should know that the speech with which we passed our time was, I suppose you could say, about love.`,
        `Lysias' work is designed for the attempted seduction of a good-looking boy — but (and this is the exquisite aspect of it) by someone who isn't in love with the boy!`,
        `He claims, you see, that you should gratify someone who is not in love with you rather than someone who is.`,
      ],
    },
    {
      character: Character.Socrates,
      speech: [
        `Excellent!`,
        `If only he would write a speech about how you should gratify a poor man rather than a rich one, an elderly man rather than a young one, and so on for all the other attributes which I and most of us have!`,
        `Then his speeches would really be sociable and would serve the common good.`,
        `Anyway, I'm so keen to hear it that I'll keep up with you even if you walk to Megara — up to the wall there and back again, as Herodicus recommends.`,
      ],
    },
    {
      character: Character.Phaedrus,
      speech: [
        `My dear Socrates, what do you mean?`,
        `Do you think an amateur like me could remember and do justice to a composition it took Lysias, the cleverest speech-writer of today, ages to write in his free time?`,
        `Far from it — though I'd rather that than a whole pile of gold.`,
      ],
    },
    {
      character: Character.Socrates,
      speech: [
        `I tell you, Phaedrus, if I don't know Phaedrus, I'm a stranger to myself too.`,
        `But neither of these is the case. I'm sure that once he had heard Lysias' speech he didn't hear it just once. No, he nagged him to read it again and again— and I'm sure that Lysias was very happy to comply.`,
        `And I doubt that even this was enough for Phaedrus. Eventually he borrowed the scroll himself and pored over those parts of the speech he particularly wanted to look at, and continued with this, sitting in his place from daybreak onwards,`,
        `until he got tired and went for a walk, by which time, I would say — yes, by the dog, I would! — he knew the speech by heart, unless it was really quite long.`,
        `And so he went for a walk outside the city walls to rehearse the speech.`,
        `Then he came across someone who is sick with passion for hearing speeches. When he saw him... well, when he saw him he was delighted to find someone with whom he could share his frenzy, so he told him to lead the way.`,
        `But when this speech-lover asked him to repeat the speech, he coyly pretended that he didn't want to, even though he was eventually going to repeat it even if he had to force it on an unwilling audience.`,
        `So, Phaedrus, why don't you ask him right here and now to do what he's soon going to do anyway?`,
      ],
    },
    {
      character: Character.Phaedrus,
      speech: [
        `It's certainly true that I'll be far better off if I repeat it as best I can,`,
        `since I don't think you're ever going to let me go until I've made some sort of attempt at reciting it.`,
      ],
    },
    {
      character: Character.Socrates,
    ...
    },
    {
      ...
      speech: [
        ...
        `You see, in actual fact, Socrates, I honestly didn't learn it word for word.`,
        `But I shall go through the general sense of almost all the points of difference, according to Lysias, between the behavior of the lover and that of the non-lover,`,
        `and summarize each point in order, from first to last.`,
      ],
    },
    {
      character: Character.Socrates,
      speech: [
        `Yes, but first, my friend, show me what you've got in your left hand under your clothing.`,
        `I suspect you've got the actual speech.`,
        `If I'm right, you should know that, fond as I am of you, I have no intention of letting you practice on me when Lysias is here too.`,
    ...
    },
    {
      character: Character.Phaedrus,
      speech: [
        `(producing the written speech) Enough! Socrates, you've dashed my hope of using you as my training-ground.`,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `Let's turn off the road here and walk alongside the Ilissus.`,
        `Then we can find somewhere quiet to sit down, wherever we like.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Phaedrus,
      speech: [
        `No, I will—and it will be in the form of an oath. I swear to you—hmm, which of the gods shall I swear by? Do you mind if I take this plane tree here?—that unless you make the speech for me, in the presence of this tree, I shall neither recite nor report for you anyone's speech ever again.`,
      ],
    },
    {
      character: Character.Socrates,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `Keep quiet and listen to me, then. For in fact this spot really does seem infused with divinity, so don't be surprised if, as may happen, I become possessed by the Nymphs as my speech progresses. As it is I'm already more or less chanting dithyrambs.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `Out of respect for him, then, and fear of Love himself, I want to wash away the unpleasant taste, so to speak, of these two speeches with a fresh one. And I'd recommend Lysias too to compose a speech as soon as he can about how one should gratify a lover rather than a non-lover in return for favours received.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `Phaedrus, you're making a fool of yourself in saying that. You badly misjudge your friend if you think he's as easily frightened as you suggest. But perhaps you think that the man who was laying into him really meant all his rudeness.`,
      ],
    },
    {
      character: Character.Phaedrus,
      speech: [
        `Yes, he seemed to, Socrates. I'm sure you know as well as I do that the people with the most power and the highest positions in our communities are ashamed to compose speeches and let anything they themselves have written survive, because they're worried that subsequent generations might think badly of them and call them 'sophists'.`,
      ],
    },
    {
      character: Character.Socrates,
      speech: [
        `You've forgotten about the 'sweet bend', Phaedrus. And apart from the bend you're forgetting just how much the politicians with the highest self-regard adore speech-writing and the survival of their written works. At any rate, they feel so much affection for those who admire any composition of theirs that each time, at the beginning of the piece, they inscribe the names of its admirers.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `Step forward, noble creatures, and persuade Phaedrus, the father of fair children, that unless he practices philosophy to a sufficiently high degree of competence, he will never even get close to being a competent speaker on any topic. Let Phaedrus be the one to answer.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `All right. Wouldn't rhetoric, in general, be a kind of skilful leading of the soul by means of words, not only in public gatherings such as the lawcourts, but also in private meetings? Isn't it the same skill whether it is dealing with slight or great issues, and something which, seen aright, is no more valuable when it is concerned with important matters than it is when it is dealing with trivia? Is this what you've heard about it, or what?`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `Now, we realize, don't we, that the Eleatic Palamedes is such a skilful speaker that he makes the same things appear to his audience similar and dissimilar, or one and many, or again at rest and in motion?`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `Yes, and you're more likely to get away with shifting to an opposite position if you do so gradually rather than in big leaps, aren't you?`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `It follows that if you are to deceive someone else, while remaining undeceived yourself, you must know precisely how things resemble and differ from one another.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `So clearly it is similarities which are responsible for people being flooded by the experience of holding opinions which do not correspond to the facts—that is, of being deceived.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `In that case, my friend, it looks as though a person who doesn't know the truth, but has restricted his research to opinions, will come up only with a ridiculously unsystematic form of rhetorical expertise.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `But what about when someone says 'right' or 'good'? Isn't it the case that we all go off in different directions, and we disagree with one another and with ourselves?`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `He certainly seems to be nowhere near doing what we wanted to see him doing. He doesn't begin at the beginning at all, but tries to swim through his speech on his back and the wrong way round, starting at the end. He begins with what the lover would say to his beloved when he has come to the end of his speech. Or am I wrong, Phaedrus, dear heart?`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `But there are two kinds of madness, one caused by human illnesses, the other by a divine release from the norms of conventional behavior.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `What do you mean? Is there possibly something worthwhile which is liable to expertise, but in which collection and division are not involved? If so, you and I must do all we can not to belittle it. We must state exactly what the remaining part of rhetoric is.`,
      ],
    },
    {
      character: Character.Phaedrus,
      speech: [
        `There are plenty of aspects left, of course, Socrates—those that have been written down in the handbooks on rhetoric.`,
      ],
    },
    {
      character: Character.Socrates,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `Of course. Oh yes, he also recommends 'refutation' and 'extra refutation', whether one is prosecuting or defending. And how can we fail to bring forward the excellent Evenus of Paros, who was the first to invent 'insinuation' and 'indirect praise'? It's also said that his speeches included indirect censures written in verse to make them memorable. He's a clever fellow. And shall we leave Tisias and Gorgias asleep, when they saw that arguments from probability were preferable to the truth? They also used the power of speech to make trivia appear important and important things trivial, they got novelties to sound old and old things fresh and new, and whatever the subject they discovered how to pare their speech right down or extend it indefinitely. Prodicus once heard me saying this and he replied with a laugh that he alone had discovered the professional way of speaking: speeches should not be long or short, he said, but just the right length.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `It seems likely, Phaedrus, and perhaps it's even inevitable, that the ability to become a perfect performer in this sphere depends on the same factors as it does in every other sphere. If you naturally have what it takes to be an expert orator, you'll be a famous orator, once you have supplemented natural ability with knowledge and practice. If you lack any of these three factors, you'll be less than perfect in that respect. But in so far as there's a technical aspect to rhetoric, I'm not convinced that the way Lysias and Thrasymachus go about it is right.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `So the soul is what he focuses all his efforts on, since it is the soul in which he is trying to produce conviction. Right?`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `It obviously follows that Thrasymachus and anyone else who takes the teaching of rhetorical expertise seriously will first describe the soul with such absolute precision that we are able to see whether it has a single, uniform nature, or whether it is complex, like the body. For this is what we're saying it is to reveal the nature of anything.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `You're right, and that's exactly why we must turn all our arguments upside down to see if we can somehow find an easier and shorter route to it, so that no one need go pointlessly off on a long, rough road when he could take a short, smooth one. If you can offer any help—you might have heard something from Lysias or someone else—do please try to remember it and tell me.`,
      ],
    },
    {
      character: Character.Phaedrus,
    ...
    },
    {
      character: Character.Socrates,
      speech: [
        `No. He'll probably sow and write his gardens of letters for amusement, if at all, as a way of storing up things to jog his own memory when 'he reaches the age of forgetfulness', and also the memory of anyone else who is pursuing the same course as him. He'll happily watch these delicate gardens growing, and he'll presumably spend his time diverting himself with them rather than the symposia and so on with which other people amuse themselves.`,
      ],
    },
    {
      character: Character.Phaedrus,
      speech: [
        `What a wonderful kind of diversion you're describing, Socrates—that of a person who can amuse himself with words, as he tells stories about justice and the other things you mentioned—compared with the trivial pastimes of others!`,
      ],
    },
    {
      character: Character.Socrates,
      speech: [
        `Yes, that's right, my dear Phaedrus. But it's far better, in my opinion, to treat justice and so on seriously, which is what happens when an expert dialectician takes hold of a suitable soul and uses his knowledge to plant and sow the kinds of words which are capable of defending both themselves and the one who planted them. So far from being barren, these words bear a seed from which other words grow in other environments. This makes them capable of giving everlasting life to the original seed, and of making the man who has them as happy as it is possible for a mortal man to be.`,
      ],
    },
    {
      character: Character.Phaedrus,
