...
export const LachesAllen: Turn<LachesCharacter>[] = [
  ...
  },
  {
    character: LachesCharacter.Lysimachus,
    speech: [
      `How do you mean, Laches? Socrates here is concerned for things of this sort?`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Nicias,
    speech: [
      `And I can state this as strongly as Laches. In fact, just recently he recommended a music teacher for my son-Damon, a pupil of Agathocles, who's quite accomplished not only in music but in everything else worth spending time on for young men of that age.`,
    ],
  },
  {
    character: LachesCharacter.Lysimachus,
    speech: [
      `People my own age hardly get to know the younger generation anymore, Socrates and Nicias and Laches: we spend so much time at home due to old age. But if you can offer any good counsel to e these fellow demesmen of yours, son of Sophroniscus, you must do so. You ought to, for actually you're our friend through your father. Your father and I were ever two friends and comrades, and he died before we ever disagreed in anything. A memory came back to me just now as we were speaking: these young men here talk with one another at home and often mention Socrates and praise him highly. I never thought to ask if they meant the son of Sophroniscus. Well, tell me, boys, is this the Socrates you've mentioned so often?`,
    ],
  },
  {
