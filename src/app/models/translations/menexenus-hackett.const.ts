  ...
  turns: [
    ...
    },
    {
      ...
      speech: [
        ...
        `\n\t"The dead themselves she never fails to honor: every year she herself celebrates for all publicly the rites that are celebrated for each in private, and in addition she holds contests in athletic prowess and horsemanship and in music and poetry of every kind. Quite simply, for the dead she [249c] stands as son and heir, for their sons as a father, for their parents as a guardian; she takes complete and perpetual responsibility for all of them.`,
