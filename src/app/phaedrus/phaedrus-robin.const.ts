...
export const PhaedrusRobin: Turn<PhaedrusCharacter>[] = [
  ...
  },
  {
    character: PhaedrusCharacter.Socrates,
    speech: [
      `Excellent! If only he would write a speech about how you should gratify a poor man rather than a rich one, an elderly man rather than a young one, and so on for all the other attributes which I and most of us have! Then his speeches would really be sociable and would serve the common good. Anyway, I'm so keen to hear it that I'll keep up with you even if you walk to Megara—up to the wall there and back again, as Herodicus recommends.`,
    ],
  },
  {
    character: PhaedrusCharacter.Phaedrus,
  ...
  },
  {
    character: PhaedrusCharacter.Phaedrus,
    speech: [
      `Here's what I'll do, then. You see, in actual fact, Socrates, I honestly didn't learn it word for word. But I shall go through the general sense of almost all the points of difference, according to Lysias, between the behaviour of the lover and that of the non-lover, and summarize each point in order, from first to last.`,
    ],
  },
  {
    character: PhaedrusCharacter.Socrates,
    speech: [
      `Yes, but first, my friend, show me what you've got in your left hand under your clothing. I suspect you've got the actual speech. If I'm right, you should know that, fond as I am of you, I have no intention of letting you practise on me when Lysias is here too. Come on, then, show me what you've got.`,
    ],
  },
  {
    character: PhaedrusCharacter.Phaedrus,
