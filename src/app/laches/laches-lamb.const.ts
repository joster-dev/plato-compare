...
export const LachesLamb: Turn<LachesCharacter>[] = [
  ...
  },
  {
    ...
    speech: [
      ...
      `Has Socrates here given his attention to anything of this sort?`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Nicias,
    speech: [
      `I too might perhaps be in as good a position as Laches to inform you about that;`,
      `for quite recently he introduced to myself a music-teacher for my son—Damon, pupil of Agathocles,`,
      `who is not only the most exquisitely skilled of musicians,`,
      `but in every other way as profitable a companion as you could wish for young men of that age.`,
    ],
  },
  {
    character: LachesCharacter.Lysimachus,
    speech: [
      `It is not possible, Socrates, Nicias, and Laches, for men of my years to continue to know our juniors,`,
      `because old age makes us spend most of our time at home;`,
      ...
      `And it is only right that you should : for you happen to be our friend through your father ;`,
      `he and I were constant companions and friends,`,
      `and he died without ever having a single difference with me.`,
      `And a certain recollection comes back to me on hearing what has just been said :`,
      `for these boys, in talking with each other at home, frequently mention Socrates in terms of high praise ;`,
      `but I have never asked them whether they meant the son of Sophroniscus.`,
      `Now tell me, my boys, is this the Socrates whose name you have mentioned so often?`,
    ],
  },
  {
  ...
  },
  {
    character: LachesCharacter.Lysimachus,
    speech: [
      `On my soul, Socrates, it is good to know that you keep up your father's name, which was a most honorable one,`,
      `both on general grounds and particularly because of the intimate relation in which you and we shall equally feel ourselves to be.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
    speech: [
      `Indeed, Lysimachus, he is a person you must not lose hold of;`,
      `for I have observed him elsewhere too keeping up not merely his father's but his country's name.`,
      `He accompanied me in the retreat from Delium,`,
      `and I assure you that if the rest had chosen to be like him,`,
      `our city would be holding up her head and would not then have had such a terrible fall.`,
    ],
  },
  {
    character: LachesCharacter.Lysimachus,
    speech: [
      `Socrates, this is indeed splendid praise`,
      `which you are now receiving from men whose word is of great weight, and for such conduct as wins their praise.`,
      `So let me tell you that I rejoice to hear this and to know you have such a good reputation ;`,
      `and you in return must count me as one of your warmest well-wishers.`,
      `You ought indeed, on your own part, to have visited us before, and treated us on intimate terms, as you have a right to do :`,
      `now, however, that we have discovered each other,`,
      `from to-day onwards you must make a point of sharing our thoughts and getting to know us and our young people also,`,
      `that you and they may in your turn preserve the friendship of our houses.`,
      `That, how- ever, you will do yourself, and we will remind you of it another time :`,
      `but what do you say of the matter on which we began to speak?`,
      `What is your view?`,
      `Is the accomplishment of fighting in armour a suitable one for our boys to learn or not?`,
    ],
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `On that matter, Lysimachus, I will do my best to advise you, so far as I can, and also to do all the rest that you so kindly ask.`,
      `It seems to me, however, most proper that I, being so much younger and less experienced than you and your friends, should first hear what they have to say, and learn of them ; and then, if I have anything else to suggest as against their remarks, I might try to explain it and persuade you and them to take my view. Come, Nicias, let one or other of you speak.`,
    ],
  },
  {
    character: LachesCharacter.Nicias,
    speech: [
      `There is no difficulty about that, Socrates.`,
      `For in my opinion this accomplishment is in many ways a useful thing for young men to possess.`,
      `It is good for them, instead of spending their time on the ordinary things to which young men usually give their hours of leisure, to spend it on this,`,
      `which not only has the necessary effect of improving their bodily health—since it is as good and strenuous as any physical exercise—but`,
      `is also a form of exercise which, with riding, is particularly fitting for a free citizen ;`,
      `for only the men trained in the use of these warlike implements can claim to be trained in the contest whereof we are athletes and in the affairs wherein we are called upon to contend.`,
      `Further, this accomplishment will be of some benefit also in actual battle, when it comes to fighting in line with a number of other men ;`,
      `but its greatest advantage will be felt when the ranks are broken, and you find you must fight man to man,`,
      `either in pursuing someone who is trying to beat off your attack, or in retreating yourself and beating off the attack of another.`,
      `Whoever possessed this accomplishment could come to no harm so long as he had but one to deal with, nor yet, perhaps, if he had several ; it would give him an advantage in any situation.`,
      `Moreover, it is a thing which impels one to desire another noble accomplishment ;`,
      `for everyone who has learnt how to fight in armour will desire to learn the accomplishment which comes next, the management of troops ;`,
      `and when he has got that and once taken a pride in his work he will push on to attain the whole art of generalship.`,
      `It is evident already that all accomplishments and pursuits in the military sphere are both honorable and valuable to a man, either in acquisition or in practice ; and this particular one may well be an introduction to them.`,
      `And we can make this addition—no slight one—to its claims, that this science will make any man individually a great deal bolder and braver in war.`,
      `Nor let us disdain to mention, even though some may think it a rather slight matter,`,
      `that it will give him a smarter appearance in the place where a man should look smartest,`,
      `and where at the same time he will appear more terrible to the enemy because of his smartness.`,
      `So my opinion is, Lysimachus, as I say, that we ought to teach this skill to our young men, and I have told you my reasons for so thinking.`,
      `But if Laches has a different view to state, I shall be as glad as anyone to hear it.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
    speech: [
      `Well, Nicias, I am loth to say of any sort of accomplishment that it ought not to be learnt ;`,
      `for it seems good to know all things.`,
      `And besides, if this skill in arms is an accomplishment, as they say who teach it, and as Nicias terms it, it ought to be learnt ;`,
      `while if it is not an accomplishment, and those who promise to give it are deceiving us,`,
      `or if it is an accomplishment, but not a very important one, what can be the good of learning it?`,
      `I speak of it in this way from the following point of view :`,
      `I conceive that if there were anything in it, it would not have been overlooked by the Lacedaemonians,`,
      `whose only concern in life is to seek out and practice whatever study or pursuit will give them an advantage over others in war.`,
      `And if they have overlooked it, at any rate these teachers of it cannot have overlooked the obvious fact that the Lacedaemonians are more intent on such matters than any of the Greeks,`,
      `and that anybody who won honour among them for this art would amass great riches elsewhere, just as a tragic poet does who has won honour among us.`,
      `And for this reason he who thinks himself a good writer of tragedy does not tour round with his show in a circuit of the outlying Attic towns,`,
      `but makes a straight line for this place and exhibits to our people, as one might expect.`,
      `But I notice that these fighters in armour regard Lacedaemon as holy ground where none may tread, and do not step on it even with the tips of their toes,`,
      `but circle round it and prefer to exhibit to any other people,`,
      `especially to those who would themselves admit that they were inferior to many in the arts of war.`,
      `Furthermore, Lysimachus, I have come across more than a few of these persons in actual operations, and I can see their quality.`,
      `Indeed, we can estimate it offhand : for, as though it were of set purpose, not one of these experts in arms has ever yet distinguished himself in war.`,
      `And yet in all the other arts, the men who have made a name are to be found among those who have specially pursued one or other of them ;`,
      `while these persons, apparently, stand out from the rest in this particularly hapless fate of their profession.`,
      `Why, this man Stesilaus, whom you watched with me in that great crowd as he gave his performance and spoke in those high terms of himself before us,`,
      `I have watched elsewhere giving a finer entertainment in the form of a very real display that he made against his will.`,
      `The ship on which he was serving struck a transport vessel,`,
      `and he was using in the fight a combination of a scythe and a spear—a remarkable weapon that suited so remarkable a man.`,
      `Well, the story of this fellow's doings is hardly of enough interest in the main,`,
      `but you must hear the upshot of his device of a scythe fixed to a spear.`,
      `As he was fighting, it stuck somehow in the other ship's rigging, and held fast ;`,
      `so Stesilaus pulled at it in the hope of getting it free, but he could not, and the ships were passing by each other.`,
      `For the first moments he ran along in his ship holding on to his spear ;`,
      `but as the other ship sheered off from his and drew him after,`,
      `still holding the spear, he let it slip through his hand until he gripped the butt-end of the shaft.`,
      `From the crew of the transport there came laughter and clapping at his posture,`,
      `and when someone aimed a stone at him which hit the deck near his feet, and he let go the spear,`,
      `the troops on the warship in their turn could no longer restrain their laughter, as they saw the notable scythe-spear dangling from the transport.`,
      `Now, there may perhaps be something in this art of theirs, as Nicias argues,`,
      `but at any rate that is my impression of it, in the cases I have met with.`,
      `Hence, as I said at the beginning, whether it be an accomplishment, and one of but little use,`,
      `or not an accomplishment, but only supposed and pretended to be such, it is not worth the trouble of learning it.`,
      `For indeed I hold that if a man who was a coward believed that he possessed it, his only gain would be in rashness,`,
      `which would make his true nature the more conspicuous ;`,
      `while if he were brave, people would be on the look-out for even the slightest mistake on his part, and he would incur much grievous slander ;`,
      `for the pretension to such skill arouses jealousy,`,
      `so that unless a man be prodigiously superior to the rest in valour he cannot by any means escape being made a laughing-stock through professing to be so skilled.`,
      `Such is my opinion, Lysimachus, of the interest taken in this accomplishment ;`,
      `but do as I told you at the beginning ; you are not to let our friend Socrates go,`,
      `but must request him to advise us according to his judgement on the matter in hand.`,
    ],
  },
  {
    character: LachesCharacter.Lysimachus,
    speech: [
      `Well, I ask it of you, Socrates :`,
      `for indeed our members of council, as it were, seem to me to need someone who will decide between them.`,
      `Had these two agreed, we should not have required this help so much ; but as it is—for Laches, you see, has voted on the opposite side to Nicias—it`,
      `is as well that we should hear your view and see on which side you cast your vote.`,
    ],
  },
  {
    character: LachesCharacter.Socrates,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `And we say that our present subject is an accomplishment studied for the sake of young men's souls?`,
    ],
  },
  {
    character: LachesCharacter.Nicias,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `Yes, I have, Laches ; people, that is, whom you would not care to trust on their mere statement that they were good practitioners,`,
      `unless they could put forward some example of their personal skill — some work well carried out—not in one only, but several cases.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
    speech: [
      `That is truly spoken.`,
    ],
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `We also, therefore. Laches and Nicias—since Lysimachus and Melesias have invited us to a consultation on their sons,`,
      `whose souls they are anxious to have as good as possible—should bring to their notice what teachers we have had,`,
      `if we say that we have any to mention, who being themselves good to begin with, and having treated the souls of many young people, taught us also in due course and are known to have done so.`,
      `Or if any of ourselves says he has had no teacher, but has however some works of his own to speak of, and can point out to us what Athenians or strangers, either slaves or freemen, are acknowledged to owe their goodness to him, let him do so.`,
      `But if there is nothing of the sort to be found amongst us, let us bid them look elsewhere ; for we cannot run a risk with our good friends' children where we may ruin them, and so bring upon us the most grievous of accusations from our nearest and dearest.`,
      `Now I, Lysimachus and Melesias, am the first to avow that I have had no teacher in this respect ; and yet I have longed for such lessons from my youth up.`,
      `But I have not the means to pay fees to the sophists, who were the only persons that professed to be able to make me a complete gentleman ; and to this moment I remain powerless to discover the art myself.`,
      `But I should not be surprised if Nicias or Laches has discovered or learnt it : for they have more means at their command to enable them to learn from others, and they are also older, and have had time to discover it.`,
      `Indeed, I regard them as able to educate a man : for they would never declare their minds so freely on pursuits that are beneficial or harmful to a youth unless they felt confident that they had the requisite knowledge.`,
      `And I have entire confidence in them myself, except that I wondered at their differing from each other.`,
      `I therefore make this counter-request of you, Lysimachus : just as Laches urged you a moment ago not to release me but to ask me questions, so I now call upon you not to release Laches or Nicias, but to question them in these terms :`,
      `" Socrates says that he has no understanding of the matter, and that he is not competent to decide which of your statements is true ; that he has never been either a discoverer or a learner of anything of the sort.`,
      `But you, Laches and Nicias, are each to tell us who is the cleverest person you have heard on the upbringing of youth ; whether you have knowledge of it by learning from someone or by discovering it yourselves ;`,
      `and if you learnt it, who were your teachers respectively, and what other colleagues they had : in order that, if you are not at leisure through the demands of public business,`,
      `we may go to them and induce them either with gifts or good turns or with both to undertake the care of our and your children together, and so prevent them from turning out knaves and disgracing their ancestors.`,
      `But if you have made the grand discovery yourselves, give us an instance to show what other persons you have succeeded in changing, by your care of them, from knaves to honest gentlemen.`,
      `For if you are now going to make your first attempt at educating, you must beware lest you try your experiment, not on a corpus vile,`,
      `but on your sons and the children of your friends, and you prove to be a mere case, as the proverbial saying has it, of starting pottery on a wine-jar.`,
      `So tell us what you claim, or do not claim, as your resources and acquirements in this kind."`,
      `There, Lysimachus, demand that from these good persons, and do not let them off.`,
    ],
  },
  {
    character: LachesCharacter.Lysimachus,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `Then let our first endeavour be. Laches, to say what courage is : after that we can proceed to inquire in what way our young men may obtain it, in so far as it is to be obtained by means of pursuits and studies. Come, try and tell me, as I suggest, what is courage.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `I will explain, so far as I can : let us take that man to be courageous who, as you describe him yourself, stays at his post and fights the enemy.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `Well, as the Scythians are said to fight, as much fleeing as pursuing ; and as you know Homer says in praise of Aeneas' horses, that they knew " how to pursue and to flee in fright full swiftly this way and that way ; " and he glorifies Aeneas himself for this very knowledge of fright, calDng him " prompter of fright."`,
    ],
  },
  {
    character: LachesCharacter.Laches,
    speech: [
      `And very properly too, Socrates ; for he was speaking of chariots ; and so are you speaking of the mode of the Scythian horsemen. That is the way of cavalry fighting ; but with men-at-arms it is as I state it.`,
    ],
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `Except, perhaps, Laches, in the case of the Spartans. For they say that at Plataea, when the Spartans came up to the men with wicker shields, they were not willing to stand and fight against these, but fled ; when, however, the Persian ranks were broken, the Spartans kept turning round and fighting like cavalry, and so won that great battle.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Laches,
    speech: [
      `Well then, I take it to be a certain en- durance of the soul, if I am to speak of the natural quality that appears in them all.`,
    ],
  },
  {
    character: LachesCharacter.Socrates,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `Or what do you call it in the case of a doctor who, when his son or anyone else is suffering from inflammation of the lungs and begs for something to drink or eat, inflexibly and enduringly refuses?`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `Whereas now, on the contrary, we say that this base thing—fooUsh endurance—is courage.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `Hence I presume that, on your showing, you and I, Laches, are not tuned to the Dorian harmony : for our deeds do not accord with our words. By our deeds, most likely, the world might judge us to have our share of courage, but not by our words, I fancy, if they should hear the way we are talking now.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `That which enjoins endurance. And, if you please, let us too be steadfast and enduring in our inquiry, so as not to be ridiculed by courage herself for faihng to be courageous in our search for her, when we might perchance find after all that this very endurance is courage.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Nicias,
    speech: [
      `I say. Laches, that it is this—the knowledge of what is to be dreaded or dared, either in war or in anything else.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Nicias,
    speech: [
      `No, it seems to me, Socrates, that Laches wants to have it proved that I am talking nonsense, because he was proved a moment ago to be in the same case himself.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Laches,
    speech: [
      `Nor, I fancy, farmers either. And yet they, I presume, know what is to be dreaded in farming, and every other skilled worker knows what is to be dreaded and dared in his own craft ; but they are none the more courageous for that.`,
    ],
  },
  {
    character: LachesCharacter.Socrates,
  ...
  },
  {
    character: LachesCharacter.Nicias,
    speech: [
      `Much rather the man of whom I speak, my dear sir : for the seer's business is to judge only the signs of what is yet to come—whether a man is to meet with death or disease or loss of property, or victory or defeat in war or some other contest ; but what is better among these things for a man to suflFer or avoid suffering, can surely be no more for a seer to decide than for anyone else in the world.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `I agree that it is out of place. Laches : but let us see : perhaps Nicias thinks he does mean some- thing, and is not talking just for the sake of talking. So let us ask him to explain more clearly what is in his mind ; and if we find that he means something, we will agree with him ; if not, we will instruct him.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `Indeed it is obvious, Nicias, that you at least do not believe that even the Crommyonian sow ^ could have been courageous. I say this not in jest, but because I conceive it is necessary for him who states this theory to refuse courage to any wild beast, or else to admit that a beast like a lion or a leopard or even a boar is so wise as to know what only a few men know because it is so hard to per- ceive. Why, he who subscribes to your account of courage must needs agree that a lion, a stag, a bull, and a monkey have all an equal share of courage in their nature.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
    speech: [
      `Heavens, Socrates, how admirably you argue ! Now answer us sincerely, Nicias, and say whether those animals, which we all admit to be covirageous, are wiser than we are ; or whether you dare, in contradiction of ever}'one else, describe them as not even courageous.`,
    ],
  },
  {
    character: LachesCharacter.Nicias,
    speech: [
      `No, Laches, I do not describe animals, or anything else that from thoughtlessness has no fear of the dreadful, as courageous, but rather as fearless and foolish. Or do you suppose I describe all children as courageous, that have no fear because they are thoughtless .'' I rather hold that the fearless and the courageous are not the same thing. In my opinion very few people are endowed with courage and forethought, while rashness, boldness, and fear- lessness, with no forethought to guide it, are found in a great number of men, women, children, and animals. So you see, the acts that you and most people call courageous, I call rash, and it is the prudent acts which I speak of that are courageous.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
    speech: [
      `Mark you, Socrates, how finely, as he fancies, my friend decks liimself out ^\^th his words ! And how he attempts to deprive of the distinction of courage those whom everyone admits to be courageous!`,
    ],
  },
  {
    character: LachesCharacter.Nicias,
    speech: [
      `I am not referring to you. Laches, so do not be frightened : for I grant that you, and Lamachus also, are wise, since you are courageous, and I say the same of numerous other Athenians.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
    speech: [
      `I will not say what I could say in answer to that, lest you call me a true son of Aexone.`,
    ],
  },
  {
    character: LachesCharacter.Socrates,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `There is still a third point on which we must see if you are in agreement with us.`,
    ],
  },
  {
    character: LachesCharacter.Nicias,
  ...
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `Then courage is knowledge not merely of what is to be dreaded and what dared, for it com- prehends goods and evils not merely in the future, but also in the present and the past and in any stage, like the other kinds of knowledge.`,
    ],
  },
  {
    character: LachesCharacter.Nicias,
  ...
  },
  {
    character: LachesCharacter.Laches,
    speech: [
      `And I, in fact, supposed, my dear Nicias, that you were going to discover it, when you showed such contempt for the answers I made to Socrates : indeed I had very great hopes that the wisdom you derived from Damon would avail you for the discovery.`,
    ],
  },
  {
    character: LachesCharacter.Nicias,
    speech: [
      `That is all very fine. Laches ; you think you can now make light of the fact that you were your- self shown just now to know nothing about courage ; when my turn comes to be shown up in the same light, that is all you care, and now it will not matter to you at all, it seems, if I share your ignorance of things whereof any self-respecting man ought to have know- ledge. You really strike me, indeed, as following the average man's practice of keeping an eye on others rather than on oneself : but I fancy that for the present I have said as much as could be expected on the subject of our discussion, and that later on I must make good any defects in my statement upon it with the help of Damon—whom I know you choose to ridicule, and that without ever having seen the actual Damon—and with others' help besides. And when I have settled the matter I will enlighten you, in no grudging spirit : for I think you are in very great need of instruction.`,
    ],
  },
  {
    character: LachesCharacter.Laches,
  ...
  },
  {
    character: LachesCharacter.Lysimachus,
    speech: [
      `I gladly approve of your suggestion, Socrates ; and as I am the oldest, so I am the most eager to have lessons with the young ones. Now this is what I ask you to do : come to my house to-morrow at daybreak ; be sure not to fail, and then we shall consult on this very matter. For the present, let us break up our meeting.`,
    ],
  },
  {
    character: LachesCharacter.Socrates,
    speech: [
      `I will not fail, Lysimachus, to come to you to-morrow, God willing.`,
    ],
  },
]
